...
def starting(window):
	...
	search_button = Button(window, text = "Rechercher", font = ("Helvetica", 30), bg = 'white', fg = "black", command = partial(execution, ment.get()))
	search_button.pack()
	print(ment.get())
...
def execution(ment):
    ...
    ##################          
	#label_title = Label(window, text = "Veuillez patienter ...", font = ("courrier", 15), bg = 'black', fg = "red")
	#label_title.pack()
	#result = Recommendation(articles, my_input)
